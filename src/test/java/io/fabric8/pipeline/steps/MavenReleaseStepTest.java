...
/**
 */
public class MavenReleaseStepTest extends StepTestSupport {

    @Test
    public void testStepClass() throws Exception {
        MavenReleaseStep step = new MavenReleaseStep();
        String analyticsServiceName = step.getAnalyticsServiceName();
        System.out.println("analyticsServiceName: " + analyticsServiceName);
        assertThat(analyticsServiceName).describedAs("analyticsServiceName").isNotEmpty();
    }

    @Test
    public void testStep() throws Exception {
        StepFunction function = assertFunctionExists("mavenRelease");
